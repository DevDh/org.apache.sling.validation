        ...
        for (Field field : model.getFields()) {
            ...
            if (fieldValues instanceof String[]) {
                for (String fieldValue : (String[]) fieldValues) {
                    ...
                    Map<Validator, List<ValidatorArgument>> validators = field.getValidators();
                    for (Map.Entry<Validator, List<ValidatorArgument>> validatorEntry : validators.entrySet()) {
                        Validator validator = validatorEntry.getKey();
                        List<ValidatorArgument> arguments = validatorEntry.getValue();
